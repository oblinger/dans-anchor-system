...
| [[templates/log/{slug} Log.md\|Log]]                             | [[DAS Log\|docs]]               | Append-only dated history stream — what happened on what day.                                                                                                           |
| [[templates/messages.md\|Messages]]                   | [[DAS Messages\|docs]]          | Inter-agent background notes (vs. user-dropped Inbox input).                                                                                                            |
| [[templates/track/{slug} Track.md\|Track]]                                  | [[DAS Track\|docs]]             | The `{slug} Track/` folder shape that houses the surfaces above.                                                                                                        |
|                                                       |                                 |                                                                                                                                                                         |
| **Traits**                                            |                                 |                                                                                                                                                                         |
