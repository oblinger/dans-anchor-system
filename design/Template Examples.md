...
**Example T3.a** — the `# LOG` section of `AT/Corp/@Omnifold/@Burke Schrauth.md`, verbatim, first entry only (a complete instance of the anchored shape).
