---
description: "the golden corpus lives at both ~/ob/proj/warden and dans-anchor-system/warden; blessing writes to whichever copy you ran, so the two have drifted and a run against the stale one reports false regressions"
---
...
| | `~/ob/proj/warden/` | `dans-anchor-system/warden/` |
|---|---|---|
...
**Choice:** `git checkout -- "Warden Corpus"` on `~/ob/proj/warden`, leaving it exactly as committed.
