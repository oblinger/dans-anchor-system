...
## Blocked
- F230 — **[Blocked]** future work, parked by the user 2026-07-06 at the F229 review: extending Warden governance to the code repos would mean an anchor at the top of `~/ob/proj` —...
- [[Warden Backlog#^T002|T002]] — **[Blocked]** Queue-visible pointer to the deliberately-parked later-version scope — canonical list at [[Warden Roadmap]] § Beyond v1 (skill:post approximation ladder;...
- [[Warden Backlog#^T016|T016]] — **[Blocked]** The (B) follow-on from the T013 Q1 ruling: compile simple veto tests (path suffix/glob matches, tokenized command scans — today's R-pathguard / R-ob-remote-ops...
