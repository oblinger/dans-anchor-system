...
## Blocked
- [[Warden Backlog#^F230|F230]] — **[Blocked user-go]** future work, parked by the user 2026-07-06 at the F229 review: extending Warden governance to the code repos would mean an anchor at the top of `~/ob/proj` —...
