...
# [U+A]  [[Warden|Warden]]  -  Ready 2    Questions 5   |   Now 5    Next 1    Later 5    Verify 0    Icebox 0

## Ready
- [[F214 — Rule-system testing regime]] — **Next:** ⚠ none declared — not really Ready; add a no-user next-action or rebracket
...
## Questions
- Conversation-content **(3Q)** — designed 2026-07-01: `turn` view (7 members, transcript+ledger sourced, lazy + capped), mechanical predicate tier, `ask_oracle` binary-verdict idiom with...
