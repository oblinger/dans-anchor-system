...
**To see the actual rules:** follow [[FCT Completed Roadmap#RULESET R-completed-roadmap|the embedded block]]. 6 rules covering: companion location, body-only shape, newest-on-top ordering, standalone-grouping interleaving, structure preservation on migration, milestones-never-come-back invariant.
...
- [[FCT Completed Roadmap]] — facet spec; contains the embedded RULESET body.
- [[FCT Roadmap]] — companion facet (the migration source).
