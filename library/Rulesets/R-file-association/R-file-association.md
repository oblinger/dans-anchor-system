...
include:: [[DAS file-association#RULESET R-file-association|embedded body]]
description:: Catalog stub — the general pattern for attaching typed content to a parent doc or anchor (the three placement methods, cardinality-drives-placement, suffix naming, one-way migration, one-form-per-parent, parent linkage). Canonical body lives embedded in [[DAS file-association]].

Catalog-side stub for the file-association discipline's ruleset. The canonical body lives embedded inside the [[DAS file-association]] discipline file per the [[F133 — Rulesets folder convention + facet embedding|F133]] convention.

**To see the actual rules:** follow [[DAS file-association#RULESET R-file-association|the embedded block]]. 7 rules covering:
...
- [[DAS file-association]] — discipline spec; contains the embedded RULESET body.
