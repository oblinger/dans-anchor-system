...
Sits under [[R-doc]] (documentation conventions umbrella). Sub-discipline of [[DAS file-association]] (the broader umbrella covering structural patterns for attaching content to a parent). Cited by every facet whose content is a dated entry stream: [[FCT Discussion]] today; [[FCT Log]] pending refactor.
