...
**To see the actual rules:** follow [[FCT Design#RULESET R-design|the embedded block]]. 7 rules covering: folder presence as the lifecycle gate (replaces Code-trait check); required children (PRD, Architecture, Testing, Design.md dispatch); dispatch table lists every present child; Status file initialized when folder exists; Code trait deprecated; optional children only when applicable; scaffolding creates pre-wired structure.
...
- [[FCT Design]] — facet spec; contains the embedded RULESET body.
