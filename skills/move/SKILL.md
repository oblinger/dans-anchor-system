---
name: move
description: Move an anchor and update all path-dependent systems — Moves an anchor folder, updates HookAnchor, breadcrumbs, symlinks, and cross-references. Use when user says: "move this anchor", "relocate the project".
