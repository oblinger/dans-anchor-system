---
name: publish
description: Deploy an anchor's public page to the web — Reads config from .anchor to determine method (gitproj or github-pages). Builds index.html, copies assets, pushes to remote. Use when user says: "publish this", "deploy the page", "push to web".
tools: Read, Write, Edit, Bash, Glob, Grep
user_invocable: true
---

# Publish — Deploy an anchor's public page to the web
requires:: vault, skill:audit
