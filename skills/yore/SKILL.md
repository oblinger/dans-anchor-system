---
name: yore
description: Archive folders or files to Yore — Yore is the standard archival location. Zips with date prefix, places in parent's Yore/ subfolder. Use when user says: "archive this", "yore it", "archive to yore".
...
4. **Update references**:
   ...
   - Remove broken symlinks at any user-installed tool location
