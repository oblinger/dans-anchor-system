---
name: tidy
description: Validate and correct anchor folder structure — Scan an anchor and fix structural issues against the CAB spec — naming, dispatch tables, links, file structure. Use when user says: "tidy this", "fix the structure", "validate the anchor".
