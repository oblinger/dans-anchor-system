...
2. **The anchor page conforms** — the `{slug}.md` page follows [[DAS Anchor Page]] (H1, summary, optional figure, dispatch table — in order).
3. **The dispatch table conforms** — if the anchor page has (or should have) one, it follows [[DAS Dispatch Table]] (masthead + member zone).
...
### C — dispatch table conforms *([[DAS Dispatch Table]], + D07 / D08)* — when the page has or should have one
