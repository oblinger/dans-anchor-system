...
| `heading-spacing` | warning | ATX headings have a blank line **before** (except line-1 / immediately-post-frontmatter). The blank-*after* half was deleted 2026-08-11 — it enforced the opposite of Dan's stated heading style, 19,245 times; see the rule file and [[TINK Backlog#^T205\|T205]]. |
