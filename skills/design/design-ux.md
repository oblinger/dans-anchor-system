...
After the PRD is written. Run when the user experience needs to be designed or redesigned.
...
- **Commands, menus, and shortcuts** — the actions available to the user
- **System concepts** — the shared vocabulary for users, agents, and docs
- **Mockups** — ASCII or linked visual mockups
...
Verify every PRD user story has a corresponding UX path. If a story has no UX representation, either design one or flag it as an open question.
