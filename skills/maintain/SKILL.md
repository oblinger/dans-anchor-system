---
name: maintain
description: Keep derived files in sync within an anchor — Maintain standing synchronization orders for an anchor. When source files change, derived files are updated. Triggered automatically by maintain hook; can be invoked manually. Use when user says: "maintain this", "keep things synced", "update derived files".
