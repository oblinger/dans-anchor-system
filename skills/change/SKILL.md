...
- **Not** for anchors without `changes/` unless the user explicitly adopts the layout — adoption is deliberate, never inferred (F230 Q1: no wholesale conversion; existing-project migration is [[SKA Backlog#^F238|F238]], per-project and user-reviewed).
