...
Full flows, action space, safety analysis, config surface, and implementation order: **[[DAS MUSE Architecture|MUSE Architecture]]**. Wire-side integration only (iCloud sync, launchd trigger, quarantine handling): **[[WIRE Muse]]**.
