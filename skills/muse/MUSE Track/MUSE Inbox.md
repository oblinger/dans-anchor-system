...
> Dan ruled 2026-08-21 on [[Atticus Backlog#^T241|ATT T241]]: **route on capture** — a memo naming an agent should land in that agent's Inbox at ingest time, not wait for Daybreak. He asked for an hourly poller originally; the poller was declined and he accepted the smaller shape. Full reasoning and build spec: [[Atticus241 - The watch channel now has a reader alarm what it does not have is delivery|T241]].
>
