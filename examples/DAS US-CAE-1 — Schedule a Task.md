...
- [[FEX Architecture]] — Scheduler + TaskStore subsystems implement this
- [[HBR Testing]] — e2e test `e2e_schedule_a_task` exercises this story
- [[HBR CLI]] — full `schedule` command reference (flags, exit codes)
