...
---
:>> [[DAS]] → [[examples]] → [FEX Scheduler](hook://p/FEX%20Scheduler)
# FEX Scheduler
...
(Moved from `CAE Architecture.md` 2026-06-08 per the DAS Architecture facet rule: per-module class/function tables live in the subsystem doc, not the architecture entry-point.)
