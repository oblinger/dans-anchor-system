...
---
:>> [[DAS]] → [[FEX]] → [Harbor Latency Budget](hook://p/Harbor%20Latency%20Budget) 
...
> - **The heart is content, not navigation.** A primary data table on a leaf is not a dispatch table and does not make this page a hub — exactly the distinction a reader must make on sight. Compare [[BRDG|Bridges]], where a table of the same visual weight *is* the routing surface.
>
