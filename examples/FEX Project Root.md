...
> - **Track is a *project* row.** A **published section anchor** ([[DAS Facets]], [[DAS Skills]], [[DAS Disciplines]], [[LBR]]) has **no `track` row** — it carries no work of its own; its tracking is centralized in the dev-side **[[SKA]]** tree (per D01). Only standalone project anchors track their own work here.
