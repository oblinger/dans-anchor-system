...
| -[[DAS Examples]]- | : the examples pillar — every worked example, indexed by facet<br>→ [[DAS]] → [FEX](hook://FEX) → [DAS Examples](hook://p/DAS%20Examples)  |
| --- | --- |
