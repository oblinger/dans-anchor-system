| -[[FEX API Design]]- | : Programmatic Rust-crate surface — types, signatures, error envelope, stability + compatibility.<br>→ [[DAS]] → [[examples]] → [FEX API Design](hook://p/FEX%20API%20Design)  |
| --- | --- |
