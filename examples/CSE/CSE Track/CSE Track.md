...
| -[[CSE Track]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [CSE Track](hook://p/CSE%20Track)<br>: planning surface for the CSE example skill anchor |
| --- | --- |
| [[CSE PRD]] | product requirements — what the skill does and why |
| [[CSE Backlog]] | deferred work — items in flight or queued |
| [CSE Triage](hook://CSE%20Triage) | items needing user involvement (agent-owned) |
