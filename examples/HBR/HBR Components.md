...
| -[[HBR Components]]- | : example grouped-dispatch collection (> 15 members)<br>→ [[DAS]] → [[FEX]] → [[HBR\|HARBOR]] → [HBR Components](hook://p/HBR%20Components)  |
| --- | --- |
| Anchor | [[HBR]] (parent) |
| Related | [[DVT\|Devtools]] (grouped variant),  [[DAS Dispatch Table]],  [[DAS progressive-disclosure]], |
