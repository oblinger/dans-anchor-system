...
- [[F003 — Scheduled Catalog Checkpoint]] `[Designing]` — periodic SQLite WAL checkpoint so a crash resumes from the last good state (US-HBR-5). → [[HBR Roadmap|M3.0]]
- [[F002 — On-the-Fly Transcode Session]] `[Designing]` — per-client transcode pipeline started on a direct-play miss (US-HBR-4). → [[HBR Roadmap|M2.2]]
