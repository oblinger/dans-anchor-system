...
---
# HBR Versions
Harbor's `versions/` folder — the immutable store its published `.dmg` releases are promoted into. A worked instance of [[FCT Versions]].
...
| Related | [[FCT Versions]] (the facet),  [[HBR CLI]], |
...
See [[FCT Versions]] for the facet rules this instance satisfies.
