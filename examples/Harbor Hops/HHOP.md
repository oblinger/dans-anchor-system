...
| -[[HHOP]]- | : Harbor Hops — made-up list-spine exemplar — one machine-written row per hop<br>→ [[DAS]] → [[FEX]] → [HHOP](hook://p/HHOP)  |
| --- | --- |
...
> - **No heart.** A pure index's spine is its content — there is nothing to put between the H1 and the table because the table is above the H1. Compare [[DVT|Devtools]], which carries both.
>
