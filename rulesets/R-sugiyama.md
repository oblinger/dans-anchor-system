...
### RULE R-sugiyama-01 — Minimize edge crossings (sampled)
...
### RULE R-sugiyama-02 — Bend budget (≤2 bends per edge, soft) (sampled)
...
### RULE R-sugiyama-03 — Monotone flow direction (stated)
...
### RULE R-sugiyama-04 — Grid alignment (sampled)
