# RULESET R-markdown
include:: [[DAS markdown#RULESET R-markdown\|embedded body]]
description:: Mechanical + authoring rules for every markdown document; cited by every facet and skill that produces markdown.

Catalog-side stub for the markdown discipline's ruleset. Canonical body lives embedded inside the [[DAS markdown]] discipline file per the [[F133 — Rulesets folder convention + facet embedding|F133]] convention.

**To see the actual rules:** follow [[DAS markdown#RULESET R-markdown|the embedded block]]. 10 rules covering:
...
- [[DAS markdown]] — discipline spec; contains the embedded RULESET body.
