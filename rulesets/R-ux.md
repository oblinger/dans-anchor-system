# RULESET R-ux
include:: [[DAS UX Design#RULESET R-ux|embedded body]]
description:: Catalog stub — rules for `{slug} UX Design.md`, the *human* user-facing surface intent. Canonical body lives embedded in [[DAS UX Design]].

Catalog-side stub for the UX Design facet's ruleset. The canonical body lives embedded inside the [[DAS UX Design]] facet file per the [[F133 — Rulesets folder convention + facet embedding|F133]] convention.

**To see the actual rules:** follow [[DAS UX Design#RULESET R-ux|the embedded block]]. 8 rules covering:
...
- [[DAS UX Design]] — facet spec; contains the embedded RULESET body.
