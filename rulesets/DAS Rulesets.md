...
| [[DAS Tracking Design\|Tracking]]+ | [[R-backlog]],  [[R-query]],  [[R-status]],  [[R-log]],  [[R-messages]],  [[R-roadmap]],  [[R-completed-roadmap]],  [[R-track-group]],  [[R-track-dispatch]],  [[R-fct-icebox]],  [[R-fct-inbox]],  [[R-fct-plan-dispatch]],   |
| ↳ residue: | [[R-state-region]] — unclear which surface it governs |
...
| [[DAS Utility Design\|Utility]]+ | [[R-ob]] (owner-scoped umbrella: [[R-ob-state-mgt]] · [[R-ob-observability]] · [[R-ob-cmd-proc]] · [[R-ob-remote-ops]]),,   |
| ↳ residue: | [[R-ob]] is owner-scoped (applies by owner, not subsystem) — parked here because its rules are machine-ops flavored; may deserve its own axis |
...
*(Search and Drive own no rulesets — Search constrains via its type rules, Drive via the workflow discipline.)*
