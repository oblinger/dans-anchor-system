...
Previously named `R-skill`. Renamed to `R-skill-anchor` to disambiguate from the new [[R-skill]] umbrella (which catalogs rulesets associated with individual *skills* the agent performs, not skill-anchor traits).
