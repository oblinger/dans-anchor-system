...
include:: [[DAS Discussion#RULESET R-discussion|embedded body]]
description:: Catalog stub — rules for `# Discussion` (inline) or `{Doc} Discussions.md` (extracted), the first *document-scoped* facet. Canonical body lives embedded in [[DAS Discussion]].

Catalog-side stub for the Discussion facet's ruleset. The canonical body lives embedded inside the [[DAS Discussion]] facet file per the [[F133 — Rulesets folder convention + facet embedding|F133]] convention.

**To see the actual rules:** follow [[DAS Discussion#RULESET R-discussion|the embedded block]]. 9 rules covering:
...
- **Pattern (1)** — same dual-form (inline → extracted) precedent that [[DAS Stories]] uses.
...
- [[DAS Discussion]] — facet spec; contains the embedded RULESET body.
