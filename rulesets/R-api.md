# RULESET R-api
include:: [[DAS API Design#RULESET R-api|embedded body]]
description:: Catalog stub — rules for `{slug} API Design.md`, the *programmatic* user-facing surface intent. Canonical body lives embedded in [[DAS API Design]].

Catalog-side stub for the API Design facet's ruleset. The canonical body lives embedded inside the [[DAS API Design]] facet file per the [[F133 — Rulesets folder convention + facet embedding|F133]] convention.

**To see the actual rules:** follow [[DAS API Design#RULESET R-api|the embedded block]]. 9 rules covering:
...
- [[DAS API Design]] — facet spec; contains the embedded RULESET body.
