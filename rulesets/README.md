...
- **Trait-scoped folders** match trait names per the [[DAS Traits]] taxonomy (post-F090: Code / Skill / Topic / Paper / Simple). Sets here apply when an anchor declares the matching trait.
...
- [[DAS Decisions]] — per-anchor Decisions facet spec.
- [[DAS Traits]] — the canonical trait taxonomy.
