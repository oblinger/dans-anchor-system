...
`find` and `describe` are uncommon for skills — when relevant, fall back to the verb defaults; user overrides land in `SRCH rules/find-skill.md` / `SRCH rules/profile-skill.md` as patterns emerge.
