...
| -[[DAS Exp]]- | : `exp` is the remote-experimentation toolkit — it lets you run ML workloads on ephemeral GPU instances (typically vast.ai) without juggling SSH sessions and rsync invocations by hand.<br>→ [[DAS]] → [docs](hook://docs) → [DAS Exp](hook://p/DAS%20Exp)  |
| --- | --- |
