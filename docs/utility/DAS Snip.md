...
| -[[DAS Snip]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [DAS Snip](hook://p/DAS%20Snip)<br>: Capture rough text drops to the SNIP log and refine them inline.|
| --- | --- |
...
See `~/.claude/skills/snip/SKILL.md` for the full runbook.
