...
| -[[DAS Parley]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [DAS Parley](hook://p/DAS%20Parley)<br>: Structured discussion — talk through a topic with the user, capture decisions, and surface next steps. |
| --- | --- |
...
See `~/.claude/skills/parley/SKILL.md` for the full runbook.
