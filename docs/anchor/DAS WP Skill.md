...
| -[[DAS WP Skill]]- | : `/wp <name>` creates a new dated **work product** folder inside the current anchor's `{slug} WP/` folder.<br>→ [[DAS]] → [docs](hook://docs) → [DAS WP Skill](hook://p/DAS%20WP%20Skill)  |
| --- | --- |
