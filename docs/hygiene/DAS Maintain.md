...
| -[[DAS Maintain]]- | → [[DAS]] → [docs](hook://docs) → [DAS Maintain](hook://p/DAS%20Maintain)<br>: `/maintain` is the discipline that keeps **derived files in sync with their sources** inside an anchor. |
| --- | --- |
