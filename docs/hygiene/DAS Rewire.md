...
| -[[DAS Rewire]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [DAS Rewire](hook://p/DAS%20Rewire)<br>: Idempotent structural repair for any anchor. |
| --- | --- |
...
See `~/.claude/skills/rewire/SKILL.md` for the full runbook.
