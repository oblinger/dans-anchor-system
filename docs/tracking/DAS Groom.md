...
| -[[DAS Groom]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[skill-docs]] → [[SKL Drive]] → [SKL Groom](hook://p/DAS%20Groom)<br>: the /groom concept dossier |
| --- | --- |
...
| Facet | [[facets/FCT Track/DAS Backlog\|FCT Backlog]] (the backlog file + the five groomed states) |
