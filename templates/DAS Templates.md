...
Authored: [[templates/backlog.md|backlog]] · [[templates/completed-roadmap.md|completed-roadmap]] · [[templates/decisions.md|decisions]] · [[templates/log.md|log]] · [[templates/messages.md|messages]] · [[templates/prd.md|prd]] · [[templates/query.md|query]] · [[templates/roadmap.md|roadmap]] · [[templates/status.md|status]] · [[templates/testing.md|testing]]. Tracking-group templates completed 2026-07-12 per [[DAS Tracking Design]]; the remaining per-facet templates are generated by the Sonnet fan-out (one per facet in `facets/`, from its `DAS <X>` spec) once this pattern is ratified.
