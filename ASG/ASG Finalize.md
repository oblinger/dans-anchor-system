...
| **4. Update Status** | Move any backlog item to `## Done` with PR/commit cross-reference. Mark any roadmap milestone complete. |
| **5. Update Docs to Match Reality** | Public-API changes → update module doc. New files → update `{slug} Files.md` and Dev dispatch. Architecture change → update System Design. |
