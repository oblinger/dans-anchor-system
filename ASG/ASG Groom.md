...
---
:>> [[DAS]] → [[ASG]] → [ASG Groom](hook://p/ASG%20Groom)
# /groom — user guide
...
- **Questions** (`[Questions]`) → the open questions, each answerable in one shot, land in the anchor's `{slug} queries.md`.
