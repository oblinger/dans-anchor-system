...
| -[[SKL Utility]]- | → [[DAS]] → [[skill-docs]] → [SKL Utility](hook://p/SKL%20Utility)<br>: User guides for cross-cutting helpers — local-environment control, remote-machine bridging, agent-to-agent communication, recipe lookups, remote experimentation, capture. |
| --- | --- |
