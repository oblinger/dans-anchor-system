...
{slug} Notebook/                       <- the anchor's stream of notebooks
  A2X012 - Game Breaks/                <- one notebook: {PREFIX} - {Title}
    ...
    A2X012-001 first pass.md           <- cell 001's own doc
    A2X012-001 leaderboard.png         <- cell 001's data / figures
...
- Each cell **always has a title and its own doc**; optionally a summary (1–3 sentences) and any number of data files. **Figures** are data files that additionally embed inline in the narrative.
