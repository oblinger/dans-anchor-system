...
| -[[DAS Template Variables]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[facets\|FCT]] → [DAS Template Variables](hook://p/DAS%20Template%20Variables)<br>: the `{{PLACEHOLDER}}` system shared by file and folder templates |
| --- | --- |
