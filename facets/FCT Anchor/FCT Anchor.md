...
| -[[FCT Anchor]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[facets]] → [FCT Anchor](hook://p/FCT%20Anchor)<br>: anchor & structure facets — what makes a folder an anchor and how its files are named |
| --- | --- |
| Facets | [[FCT Anchor Page\|Anchor Page]],  [[FCT Project Page\|Project Page]],  [[FCT Folder\|Folder]],  [[FCT Dot Anchor\|Dot Anchor]],  [[FCT Anchor Tree\|Anchor Tree]],  [[FCT Naming\|Naming]],  [[FCT Claude\|Claude]],  [[FCT Move\|Move]],  [[FCT Interface\|Interface]],  [[FCT Code Repository\|Code Repository]],   |
