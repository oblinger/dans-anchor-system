...
**The ranking used to live on the folder page and no longer can.** An anchor page's top is machine-maintained, and the ranking is the one thing that must stay hand-arranged — so they are separate files. [[HBR Rocks]] and [[HBR Rocks]] are the normative pair.
