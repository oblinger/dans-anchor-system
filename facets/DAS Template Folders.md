...
| -[[DAS Template Folders]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[facets\|FCT]] → [DAS Template Folders](hook://p/DAS%20Template%20Folders)<br>: folder templates — a folder's canonical multi-doc structure |
| --- | --- |
