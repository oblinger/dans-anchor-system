...
| -[[DAS Design Docs]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[facets]] → [FCT Design Docs](hook://p/DAS%20Design%20Docs)<br>: the design-pipeline doc facets (the `{slug} Design/` contents) |
| --- | --- |
| Facets | [[DAS PRD\|PRD]],  [[DAS System Design\|System Design]],  [[DAS Architecture\|Architecture]],  [[DAS Files Architecture\|Files Architecture]],  [[DAS UX Design\|UX Design]],  [[DAS API Design\|API Design]],  [[DAS CLI\|CLI]],  [[DAS Testing\|Testing]],  [[DAS Stories\|Stories]],  [[DAS Decisions\|Decisions]],  [[DAS Roadmap\|Roadmap]],  [[DAS Completed Roadmap\|Completed Roadmap]],  [[DAS Design\|Design]],   |
