...
# Output & docs
The output / published-doc facets.

| -[[DAS Output]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[facets\|FCT]] → [DAS Output](hook://p/DAS%20Output) |
| --- | --- |
| Facets | [[DAS Cards\|Cards]],  [[DAS Outputs\|Outputs]],  [[DAS Documentation Site\|Documentation Site]],  [[DAS WP\|WP]],   |
