...
| -[[DAS Output]]- | → [[kmr]] → [[SYS]] → [[Bespoke]] → [[SKA]] → [[DAS]] → [[facets]] → [FCT Output](hook://p/DAS%20Output)<br>: the output / published-doc facets |
| --- | --- |
| Facets | [[DAS Cards\|Cards]],  [[DAS Outputs\|Outputs]],  [[DAS Documentation Site\|Documentation Site]],  [[DAS WP\|WP]],  [[DAS Docs]],  [[DAS TSK User Guide]],   |
